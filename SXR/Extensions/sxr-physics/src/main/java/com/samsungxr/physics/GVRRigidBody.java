 ...
 * <p>
 * Every {@linkplain com.samsungxr.GVRSceneObject scene object} can represent a rigid body since
 * it has a {@link GVRRigidBody} component attached to.
 *
 * You must setup the values of owner's {@link com.samsungxr.GVRTransform}, like initial position,
...
public class GVRRigidBody extends GVRPhysicsWorldObject {
    ...
    /**
     * Returns the {@linkplain GVRWorld physics world} of the {@linkplain com.samsungxr.GVRScene scene}.
     *
