...
/**
 * Is a SXREmitter of the plane shape. The particles are emitted from
...
public class SXRPlaneEmitter extends SXREmitter {
    ...
    public SXRPlaneEmitter(SXRContext gvrContext) {
        super(gvrContext);
    ...
    private static final class SXRDrawFrameListenerImpl implements SXRDrawFrameListener {
        ...
        private final WeakReference<SXRPlaneEmitter> mRef;
        private float totalTime = 0;
        private float mElapsedTime = 0;
        SXRDrawFrameListenerImpl(final SXRPlaneEmitter emitter) {
            mRef = new WeakReference<SXRPlaneEmitter>(emitter);
        }
