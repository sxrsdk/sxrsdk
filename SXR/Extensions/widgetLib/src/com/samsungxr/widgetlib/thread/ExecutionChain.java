package com.samsungxr.widgetlib.thread;
...
public class ExecutionChain {
    ...
    /**
     * Add a {@link Task} to be run on a {@link com.samsungxr.utility.Threads#spawn(Runnable)
    ...
    /**
     * A convenience method to wrap a {@link Runnable} in a {@link Task} to be
     * run on a {@link com.samsungxr.utility.Threads#spawn(Runnable) background thread}.
     *
     * @param r
     *            {@code Runnable} to run
     * @return Reference to the {@code ExecutionChain}.
