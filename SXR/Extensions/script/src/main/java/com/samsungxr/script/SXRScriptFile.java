 ...
 * <ul>
 *   <li> Use {@link SXRScriptManager#loadScript(com.samsungxr.SXRAndroidResource, String)}
 *   to load using a {@code SXRAndroidResource} object.</li>
 *   <li> Construct the {@code SXRScriptFile} object and set the script
 *   text using {@link #setScriptText(String)}, or load it from a stream using
 *   {@link #load(InputStream)}. </li>
 * </ul>
 */
public abstract class SXRScriptFile implements IScriptFile {
    private static final String TAG = SXRScriptFile.class.getSimpleName();
     ...
     *     {@code LANG_*} defined in {@link SXRScriptManager}, such
     *     as {@code LANG_LUA}, {@code LANG_JAVASCRIPT}, and so on.
     */
    public SXRScriptFile(SXRContext gvrContext, String language) {
    ...
    /**
     * Loads a script into the {@link SXRScriptFile} object.
     *
     * @param inputStream
    ...
    /**
     * Gets the script from the {@link SXRScriptFile} object.
     *
