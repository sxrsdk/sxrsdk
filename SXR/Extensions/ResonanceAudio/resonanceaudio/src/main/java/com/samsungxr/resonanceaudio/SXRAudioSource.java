 ...
 * An audio source must be added to the {@link SXRAudioManager}
 * in order to play it.
 */
public class SXRAudioSource extends SXRBehavior
{
    static private long TYPE_AUDIO = newComponentType(SXRAudioSource.class);

    private String mSoundFile;
    private volatile int mSourceId;
    private SXRAudioManager mAudioListener;
     ...
     *
     * @param gvrContext SXR context.
     */
    public SXRAudioSource(SXRContext gvrContext)
    {
        super(gvrContext);
     ...
     * a specific SXRAudioManager
     * @param listener SXRAudioManager to use for this source
     */
    void setListener(SXRAudioManager listener)
    {
