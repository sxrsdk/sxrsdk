...
public:
    ...
    MainSceneSorter(int numMatrices = 0, bool forceTransformBlock = false);
...
protected:
    ...
    virtual void add(RenderState& rstate, Node* object, Renderer& renderer);
    virtual void validate(RenderState&, Renderer& renderer);
