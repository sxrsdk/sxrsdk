...
/**
 * {@link SXRAccessibilityTalkBack} responsible for converting the value from a string variable to audio.
 */
public class SXRAccessibilityTalkBack {
     ...
     *            to be converted
     */
    public SXRAccessibilityTalkBack(Locale locale, Context context, String text) {
        mText = text;
        mLocale = locale;
        mContext = context;
