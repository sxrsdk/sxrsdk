...
public interface SXROnFinish {
     ...
     * 
     * <p>
     * With the default, {@linkplain SXRRepeatMode#ONCE run-once} animation,
     ...
     * overrides any {@linkplain SXRAnimation#setRepeatCount(int) repeat count.}
     * 
     * <p>
     * The repetitive types {@link SXRRepeatMode#REPEATED REPEATED} and
     * {@link SXRRepeatMode#PINGPONG PINGPONG} <em>do</em> pay attention to the
     ...
     * that the {@link SXRAnimation#DEFAULT_REPEAT_COUNT} is 2.
     * 
     * <p>
     ...
     * 
     * <ul>
     * <li>You can call {@link SXRAnimationEngine#stop(SXRAnimation)}. This will
     ...
     * 
     * <li>You can call {@link SXRAnimation#setRepeatCount(int)
     ...
     * 
     * <li>If the callback is also a {@link SXROnRepeat}, the
     * {@link SXROnRepeat#iteration(SXRAnimation, int)} method will be called at
     ...
     */
    void finished(SXRAnimation animation);
