...
import com.samsungxr.debug.cli.util.ArrayHashMultiMap;
import com.samsungxr.debug.cli.util.MultiMap;
...
public class Shell {
     ...
     * @see com.samsungxr.debug.cli.ShellFactory
     *
     ...
     *
     * @see com.samsungxr.debug.cli.ShellDependent
     * @see com.samsungxr.debug.cli.ShellManageable
     * 
     ...
     *
     * @see com.samsungxr.debug.cli.Shell#addMainHandler(java.lang.Object, java.lang.String)
     *
     * @param handler Object which should be registered as handler.
     * @param prefix Prefix that should be prepended to all handler's command names.
     */
     ...
     * 
     * @see com.samsungxr.debug.cli.Output
     *
     * @param line Full command line
     * @throws com.samsungxr.debug.cli.CLIException This may be TokenException
     */
