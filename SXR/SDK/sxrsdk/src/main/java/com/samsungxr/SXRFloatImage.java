...
public class SXRFloatImage extends SXRImage
{
     ...
     * @since 1.6.3
     */
    public SXRFloatImage(SXRContext gvrContext, int width, int height, float[] data)
            throws IllegalArgumentException
    {
    ...
    public SXRFloatImage(SXRContext gvrContext, int pixelFormat)
    {
     ...
     *
     * Creating a new {@link SXRFloatImage} is pretty cheap, but it's still
     ...
     * updating a texture will affect any and all {@linkplain SXRMaterial
