...
/** SXRF version strings. */
public class SXRVersion {
    /** Final HQ version. */
     ...
     * {@link SXRContext#loadTexture(SXRAndroidResource)} method.
     */
    public static final String V_1_6_5 = "1.6.5";

    /**
     * Add high-level
     * {@link SXRPicker#findObjects(SXRScene, float, float, float, float, float, float)}
     * method.
     */
    ...
    /**
     * Add API ({@link SXRContext#captureScreen3D(SXRScreenshot3DCallback)}) to
     ...
     * Add support for Future<{@link SXREyePointee}>s. Add
     * {@link SXRContext#getActivity()}.
     */
