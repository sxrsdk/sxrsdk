 ...
 * SXRShader, the signature is the simple Java class name.
 * <p>
 ...
 * <p>
 * Shaders derived from SXRShader cannot have variants and they ignore
 ...
 * light sources it is used with, you can derive from @{link SXRShaderTemplate}
 *
...
public class SXRShader
{
     ...
     */
    public SXRShader(String uniformDescriptor, String textureDescriptor, String vertexDescriptor)
    {
     ...
     */
    public SXRShader(String uniformDescriptor, String textureDescriptor, String vertexDescriptor, GLSLESVersion glslVersion)
    {
        mUniformDescriptor = uniformDescriptor;
        mVertexDescriptor = vertexDescriptor;
        mTextureDescriptor = textureDescriptor;
     ...
     *         {@link SXRLight#getUniformDescriptor()}  }
     */
     ...
     * {@link SXRLight#getVertexDescriptor()}  }
     */
     ...
     * For the more complex shaders generated by SXRShaderTemplate
     ...
     * @see SXRShaderTemplate
     */
    public String generateSignature(HashMap<String, Integer> defined, SXRLight[] lightlist)
    {
     ...
     * This function is called whenever a SXRMaterial is created
    ...
    public int bindShader(SXRContext context, IRenderable rdata, SXRScene scene, boolean isMultiview, boolean isStereo)
    {
        ...
        SXRMaterial mtl = rdata.getMaterial();
     ...
     */
    public int bindShader(SXRContext context, SXRShaderData material, String vertexDesc)
    {
        String signature = getClass().getSimpleName();
        SXRShaderManager shaderManager = context.getShaderManager();
     ...
     *         {@link SXRShaderTemplate#setSegment(String, String)}
     */
    ...
    protected void writeShader( String fileName, String sourceCode)
    {
        ...
        {
            com.samsungxr.utility.Log.e("SXRShaderTemplate", "Cannot write shader file " + fileName);
        }
