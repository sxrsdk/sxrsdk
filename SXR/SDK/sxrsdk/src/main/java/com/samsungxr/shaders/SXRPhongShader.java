...
/**
    ...
    * code.
    */
   public class SXRPhongShader extends SXRShaderTemplate
   {
       ...
       public SXRPhongShader(SXRContext gvrcontext)
       {
            super("float4 ambient_color; float4 diffuse_color; float4 specular_color; float4 emissive_color; float3 u_color; float u_opacity; float specular_exponent; float line_width; float2 u_lightmap_offset; float2 u_lightmap_scale; int u_numblendshapes; float u_blendweights[200];",
