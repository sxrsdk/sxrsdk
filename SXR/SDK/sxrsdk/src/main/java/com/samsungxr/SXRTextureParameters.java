...
public class SXRTextureParameters {
     ...
     */
    public SXRTextureParameters(SXRContext gvrContext) {
    ...
    /**
     * Returns the MIN filter of the {@link SXRTextureParameters}.
     * 
    ...
    /**
     * Returns the MAG filter of the {@link SXRTextureParameters}.
     * 
     * The returned value could be the one that was set by the calling API or
     * the default value for all the objects.
     * 
    ...
    /**
     * Returns the texture WRAP S type of the {@link SXRTextureParameters}.
     * 
     * The returned value could be the one that was set by the calling API or
     * the default value for all the objects.
     * 
    ...
    /**
     * Returns the texture WRAP T type of the {@link SXRTextureParameters}.
     * 
     * The returned value could be the one that was set by the calling API or
     * the default value for all the objects.
     * 
    ...
    public boolean isAnisotropicSupported() {
        return mSXRContext.isAnisotropicSupported;
    }
    ...
    public int getMaxAnisotropicValue() {
        if (mSXRContext.isAnisotropicSupported) {
            return mSXRContext.maxAnisotropicValue;
        }
        return -1;
    }
