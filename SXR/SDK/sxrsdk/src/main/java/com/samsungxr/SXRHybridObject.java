...
/**
 * Root of the SXRF object hierarchy.
 * 
...
public abstract class SXRHybridObject {
     ...
     */
    protected SXRHybridObject(SXRContext gvrContext, long nativePointer) {
     ...
     *            concatenated lists - see {@link SXRCollider} for an
     *            example.
     */
    protected SXRHybridObject(SXRContext gvrContext, long nativePointer,
    ...
    /**
     * Get the {@link SXRContext} this object is attached to.
     * 
     * @return The object's {@link SXRContext}.
     */
    ...
    protected void setNative(long nativePtr)
    {
        if (mNativePointer == 0)
        {
            ...
            getSXRContext().registerHybridObject(this, mNativePointer, null);
        }
    }

    /*package*/ static long[] getNativePtrArray(Collection<? extends SXRHybridObject> objects) {
        long[] ptrs = new long[objects.size()];

        int i = 0;
        for (SXRHybridObject obj : objects) {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof SXRHybridObject) {
            SXRHybridObject other = (SXRHybridObject) o;
     ...
     * to {@link SXRHybridObject#SXRHybridObject(SXRContext, long, List)}) and a
     ...
     * 
     * See the usage in {@link SXRCollider}.
     */
