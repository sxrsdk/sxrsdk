...
import com.samsungxr.debug.Stats.DescriptiveResult;
...
public class SXRStatsLine {
     ...
     */
    public SXRStatsLine(String lineTag) {
        mLineTag = lineTag;
        mLastPrintTimeMS = -1;
    ...
    protected List<SXRColumnBase<? extends Number>> mColumns =
            new ArrayList<SXRColumnBase<? extends Number>>();

    /**
     * Adds a column into the statistic line.
     * @param column The {@link SXRColumnBase} object.
     */
    public void addColumn(SXRColumnBase<? extends Number> column) {
        mColumns.add(column);
    }
    ...
    public synchronized void startLine() {
        for (SXRColumnBase<? extends Number> col : mColumns) {
            col.onStartLine();
        }
    }
    ...
    public void printLine(long periodMS) {
        long currentTime = SXRTime.getMilliTime();
    ...
    public static abstract class SXRColumnBase<T> {
         ...
         */
        public SXRColumnBase(String name) {
            this.mName = name;
        }
    ...
    public static class SXRStandardColumn<T extends Number> extends SXRColumnBase<T> {
         ...
         */
        public SXRStandardColumn(String name) {
            super(name);
        }
