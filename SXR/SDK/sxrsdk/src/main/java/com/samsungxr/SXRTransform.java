 ...
 * draws a mesh.
 * 
 * Every {@link SXRNode#getTransform() node} has a
...
public class SXRTransform extends SXRComponent {
    ...
    SXRTransform(SXRContext gvrContext) {
    ...
    private SXRTransform(SXRContext gvrContext, long ptr) {
     ...
     */
    public SXRTransform setPosition(float x, float y, float z) {
     ...
     */
    public SXRTransform setPositionX(float x) {
     ...
     */
    public SXRTransform setPositionY(float y) {
     ...
     */
    public SXRTransform setPositionZ(float z) {
     ...
     */
    public SXRTransform setRotation(float w, float x, float y, float z) {
     ...
     */
    public SXRTransform setScale(float x, float y, float z) {
     ...
     *            Scaling factor on the 'X' axis.
     */
    public SXRTransform setScaleX(float x) {
     ...
     *            Scaling factor on the 'Y' axis.
     */
    public SXRTransform setScaleY(float y) {
     ...
     *            Scaling factor on the 'Z' axis.
     */
    public SXRTransform setScaleZ(float z) {
     ...
     *            OpenGL-compatible column-major format.
     */
    public SXRTransform setModelMatrix(float[] mat) {
        if (mat.length != 16) {
     ...
     *            OpenGL-compatible column-major format.
     */
    public SXRTransform setModelMatrix(Matrix4f mat) {
     ...
     */
    public SXRTransform setRotationByAxis(float angle, float x, float y, float z) {
    ...
    public String toString() {
        return "SXRTransform " + Integer.toHexString(hashCode()) + ", positionX = " + getPositionX()
