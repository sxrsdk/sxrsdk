 ...
 * <p>
 * The gvr.xml file passed to {@link com.samsungxr.GVRActivity#setMain(GVRMain, String)}
...
public class GVRInputManager implements IEventReceiver
{
     ...
     * {@link com.samsungxr.GVRActivity#setMain}. (It is the comma-separated list
     ...
     * @see com.samsungxr.io.GVRInputManager.ICursorControllerSelectListener
     * @see #scanControllers()
     */
     ...
     * {@link com.samsungxr.GVRMain#onInit(GVRContext)} so that all the cursor objects are
