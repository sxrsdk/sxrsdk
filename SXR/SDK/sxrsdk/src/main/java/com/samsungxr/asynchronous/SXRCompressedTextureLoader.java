...
/**
 * Implement this class to use compressed texture formats that SXRF does not
 * support.
 * 
 * A {@link SXRCompressedTextureLoader} contains the logic to detect a
 ...
 * the app's {@link com.samsungxr.SXRAndroidResource.BitmapTextureCallback
...
public abstract class SXRCompressedTextureLoader {
    protected SXRCompressedTextureLoader() {
    }
     ...
     * create a {@link SXRCompressedTextureLoader} descendant. Then, before
    ...
    static List<SXRCompressedTextureLoader> getLoaders() {
        return loaders;
    }

    private static final List<SXRCompressedTextureLoader> loaders = new ArrayList<SXRCompressedTextureLoader>();
