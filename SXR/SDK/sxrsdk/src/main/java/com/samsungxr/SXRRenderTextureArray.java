 ...
 * The SXRRenderTextureArray object is used internally
 * for shadow mapping. All of the shadow maps are kept
 * in a single layered texture.
 * @see SXRShadowMap
 * @see SXRRenderTexture
 */
public class SXRRenderTextureArray extends SXRRenderTexture
{
    /**
     ...
     * used for rendering.
     * @param ctx       SXRContext to associate the texture array with.
